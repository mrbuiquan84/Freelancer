...
class EmplerSignupScreen extends StatefulWidget {
  const EmplerSignupScreen({Key? key}) : super(key: key);

  @override
  State<EmplerSignupScreen> createState() => _EmplerSignupScreen();
}

class _EmplerSignupScreen extends State<EmplerSignupScreen> {
  var unAuthAppBar = const UnAuthAppBar(
    title: StringConst.emplerSignup,
  );
          ...
          child: Container(
            ...
            child: BlocListener(
              ...
              listener: (_, state) {
                ...
                } else if (state is SignupEmplerReceivedOTPState &&
                    ModalRoute.of(context)?.settings.name !=
                        AppPages.signupEmplerOtp.name) {
                  AppRouter.toPage(
                    context,
                    AppPages.signupEmplerOtp,
