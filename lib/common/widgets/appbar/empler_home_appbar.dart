...
class EmplerHomeAppBar extends StatelessWidget implements PreferredSizeWidget {
  EmplerHomeAppBar({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    var nameWidget = BlocBuilder(
      bloc: authBloc,
      builder: (context, state) {
        // final authBloc = context.read<AuthBloc>().flcerProfileBloc;
        final info = CurrentUser.of(context).currentEmpler!;
        return RichText(
          text: TextSpan(
