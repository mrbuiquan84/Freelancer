...
class PostJobByProjectScreen extends StatefulWidget {
  const PostJobByProjectScreen({Key? key}) : super(key: key);

  @override
  State<PostJobByProjectScreen> createState() => _PostJobByProjectScreenState();
}

class _PostJobByProjectScreenState extends State<PostJobByProjectScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppAppBar(
        title: Text(StringConst.postJobByProject.toTitleCase()),
        centerTitle: true,
      ),
